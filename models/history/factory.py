...
def normalize_history_mode(name: str) -> str:
    ...
    aliases = {
        "no_history": "none", "identity": "none", "b0": "none",
        "residual": "residual", "b1": "residual",
        "uniform_mean": "uniform", "mean": "uniform", "b2": "uniform",
        "history_attention": "attention", "temporal_attention": "attention",
        "p1": "attention",
        "parameter_matched": "parameter_matched", "b3": "parameter_matched",
        "last_state": "static_lag", "latest": "static_lag",
    }
...
def build_history_aggregator(
    ...
    *,
    ...
    if mode in {"none", "parameter_matched"}:
    ...
    raise ValueError(
        ...
        "uniform/B2, attention/P1, parameter_matched/B3, or static_lag"
    )
